...
for filename in os.listdir(data_dir):
    ...
    dataset = pd.read_csv(os.path.join(data_dir, filename), sep='\t', usecols=[0])
...
#%%
#plot RMS
df_rms.plot(figsize = (24,12))
plt.show()
#plot RMS
df_kurt.plot(figsize = (24,12))
plt.show()
#plot RMS
df_skw.plot(figsize = (24,12))
plt.show()
#%%
#make csv out of the calculated values
#create dataframe with the correct size
dataset = pd.DataFrame(index=range(2113), columns=range(3))
...
#create .csv
dataset.to_csv('1st_test-ch1.csv')